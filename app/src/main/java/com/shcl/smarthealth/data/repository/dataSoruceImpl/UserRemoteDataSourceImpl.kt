...
class UserRemoteDataSourceImpl (
    ...
    override suspend fun signUp(signUpRequest: SignUpRequest): Flow<ApiResponse<SignUpResponse>?> {
        try{
            ...
            val fileBody : RequestBody = RequestBody.create("image/".toMediaTypeOrNull(), signUpRequest.picture)
            ...
            val response = userApi.signUp(
               ...
               picture = MultipartBody.Part.createFormData("picture", signUpRequest.picture , fileBody),
            )
